...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "BRADS COIN";
    string internal constant SYMBOL = "BDC";
     ...
     */
    uint256 internal maxTransactionAmount = TOTAL_SUPPLY * 15 / FEES_DIVISOR;
    ...
    */
    ...
    address internal BDC_CONTRACT = address(this);

    enum FeeType { Rfi, Burn, BDC}
...
contract BradsCoin is ReflectionToken, Pausable {
    ...
    constructor(address antibotAddress_){
